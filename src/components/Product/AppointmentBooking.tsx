...
const Accordion: React.FC = () => {
  ...
  return (
    <div className="container space-y-5 max-w-4xl w-100 shadow-orange-800 justify-center p-9 img-shadow "dir='rtl'>
      <div>
        <button className="w-full hover:text-white  bg-orange-500 p-4 rounded-xl font-bold text-right " onClick={() => toggleIndex(0)}>
          انتخاب تاریخ
        </button>
        {activeIndex === 0 && (
